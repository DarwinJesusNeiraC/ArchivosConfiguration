set number
set sw=2 expandtab shiftwidth=2 smarttab softtabstop=0
"set sw=8 expandtab shiftwidth=8 smarttab softtabstop=0
set numberwidth=1
syntax enable
set showcmd
set ruler
set showmatch
set laststatus=2 "gracias a este vemos lo blanco"
set nocompatible
